...
\begin{wraptable}{l}{7cm}
  ...
  \begin{tabular}{@{\,}r <{\hskip 5pt} !{\foo}
    ...
    2014 & \cite{Aleph2014} \textsc{aleph} updates their data. \\
  \end{tabular}
...
\begin{figure}
  ...
  \caption{Recent values for \(\alpha_s(m_\tau^2)\) from hadronic \(\tau\)
    decays. The values are taken from \cite{PDG2018, Boito2016, Pich2016,
      Davier2014, Beneke2008}, from top to bottom.}
...
\define{bs}{Borel sum}. Following the logic of the second and first category we
...
\begin{table}
  ...
  \begin{tabularx}{\textwidth}{cccYYYY}
    ...
    & \cellcolor{primary}2.300 & \cellcolor{primary}6 & \cellcolor{primary}0.3304(52) & \cellcolor{primary}-0.69(25) & \cellcolor{primary}-0.80(50) & \cellcolor{primary}0.25 \\
    & \cellcolor{primary}2.400 & \cellcolor{primary}5 & \cellcolor{primary}0.3339(70) & \cellcolor{primary}-0.91(39) & \cellcolor{primary}-1.29(83) & \cellcolor{primary}0.10 \\
...
\end{table}
Like in the \(\omega_\tau\) and \(\omega_{cubic}\) we obtain stable fits for
\(s_{min}\leq \SI{2.2}{\giga\eV}\), but the \(\chi^2/dof\) jumps to values
\(\chi^2/dof>1.6\) for smaller \(s_{min}\). The values obtained for fitting six
and seven \(s_0\)s moments are in good agreement with each other and furthermore
carry a acceptable \(\chi^2\) per \textsc{dof}. The averaged values for both
parameters are
\begin{equation}
  \alpha_s(m_\tau^2) = 0.3254(40) \qquad \text{and} \qquad C_6 = -0.81(18)
\end{equation}
...
errors. The averaged values are given by
\begin{equation}
...
(\cref{table:fitWM3AlD8}) and we will directly cite our obtained results:
\begin{equation}
...
\cite{Beneke2012} there exist another type of \textit{optimal'
  ...
  Beneke and Jamin. To differentiate the two definition we marked Pich's
...
\begin{table}
  ...
  \begin{tabularx}{\textwidth}{ccYYYY}
    ...
    & \cellcolor{primary}2.200 & \cellcolor{primary} 7 & \cellcolor{primary}
    0.3593(97) & \cellcolor{primary} -0.079(19) & \cellcolor{primary} 0.2 \\
    & \cellcolor{primary} 2.300 & \cellcolor{primary} 6 & \cellcolor{primary}
    0.3589(99) & \cellcolor{primary} -0.078(20) & \cellcolor{primary} 0.24 \\
...
\begin{table}
  ...
  \begin{tabularx}{\textwidth}{ccYYYYY}
    \toprule
    & \(s_{min}\) & \#\(s_0\)s & \(\alpha_s(m_\tau^2)\) & \(\langle aGG \rangle_I\) & \(C_{6}\) & \(\chi^2/dof\)  \\
    \midrule
    ...
    & \cellcolor{primary}2.300 & \cellcolor{primary}6 & \cellcolor{primary}0.3253(63) & \cellcolor{primary}-0.0232(75) & \cellcolor{primary}-0.69(27) & \cellcolor{primary}0.9  \\
    \midrule
  ...
  \caption{Table of our fitting values of \(\alpha_s(m_\tau^2), \langle aGG
    \rangle_I\) and \(C_{6}\) for the double pinched optimal weight
    \(\omega_{X2}(x)=(1-x)^2\) using the \textsc{bd} or \textsc{fopt} ordered by
    increasing \(s_{min}\). The errors are given in parenthesis after the
    observed value.}
...
\begin{table}
  \centering \resizebox{\textwidth}{!}{
    \begin{tabular}{ccccccccc}
      ...
      \midrule 
      \parbox[t]{2mm}{\multirow{2}{*}{\rotatebox[origin=c]{90}{\textsc{bs}}}}
      & \(\omega_{X2}\)     & 2.2 & 0.3270(54) & -0.0254(61)  & -0.77(21)   & -          & -          & 0.74 \\
      & \(\omega_{X3}\)     & 2.1 & 0.3239(40) & -0.0212(42)  & -0.63(15)   & -0.74(29)  & -          & 0.46 \\
      % & \(\omega_{X4}\) & 2.1 & 0.3248(21) & -0.02230(47) & -0.6724(63) &
...
error ranges. We have visualised the different values and errors in
\cref{fig:comparisonAlC6C8} to underline their agreement. The fits furthermore
all have a good \(\chi^2/dof\).
\begin{figure}
...
\begin{tcolorbox}[ams equation,myformula]
  \alpha_s(m_\tau^2) = 0.3308 \pm 0.0044.
\end{tcolorbox}

The dimension six \textsc{ope} contribution is very stable. Stating the result
from the kinetic weight fit yields
\begin{tcolorbox}[ams equation,myformula]
  C_6 = -0.72 \pm 0.2.
\end{tcolorbox}
