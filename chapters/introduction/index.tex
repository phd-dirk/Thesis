...
concerns \define{pt}. The lower the energies we deal with, the higher the value
of the strong coupling and the contributions of \define{np}{non\-/perturbative}
effects. Currently there are three solutions to deal with \define{np} effects:
\begin{itemize}
