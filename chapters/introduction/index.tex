...
\define{qft}{Quantum Field Theory}. is the combination of \textit{classical
...
\item \textbf{\textit{Lattice QCD}}
  (\textsc{lqcd}\nomenclature{\textsc{lqcd}}{Lattice Quantum Chromodynamics}): Is
  ...
  \item \textbf{\textit{QCD Sum Rules}}
    (\textsc{qcdsr}\nomenclature{\textsc{qcdsr}}{Quantum Chromodynamics Sum
      Rules}): Was also introduced in the late seventies by Shifman, Vainstein
...
we want to motivate the \define{rge}{Renormalisation Group Equation}, which is
