...
implication, of the running of \(\alpha_s\), concerns \define{pt}{perturbation
  theory}. The lower the energies we deal with, the higher the value of the
strong coupling and the contributions of \define{np}{non\-/perturbative}
...
\item \textbf{\textit{QCD Sum Rules}}
  (\textsc{qcdsr}\nomenclature{\textsc{qcdsr}}{Quantum Chromodynamics Sum
    Rules}): Were also introduced in the late seventies by Shifman, Vainstein and
