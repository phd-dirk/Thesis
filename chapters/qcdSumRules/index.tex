...
While applying the \textsc{ope} to the two\-/point function, we have seen, that
the perturbative part carries poles on the positive real axis. Consequently in
enclosing these poles in a contour integral the contribution of the perturbative
part will always be present. On the other hand, the higher dimension
contributions of the \textsc{ope} do not have to contribute. We can use
...
\begin{table}
  ...
  \caption{List of monomial and their corresponding ``active'' dimensions in the
    ...
    is always active, due to the poles on the positive real axis.}
