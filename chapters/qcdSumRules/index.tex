...
\begin{equation}
  \Pi_{\mu\nu}(q^2) = q_\mu q_\nu A(q^2) + q^2 g_{\mu\nu} B(q^2).
\end{equation}
By assuming that the vector current is conserved, i.e. \(\partial^\mu j_\mu() =
0\), we can make use of the \textit{Ward\-/identity}
\begin{equation}
...
\begin{equation}
  \Pi_{\mu\nu}(q^2) = (q_\mu q_\nu - q^2 g_{\mu\nu})\Pi(q^2).
\end{equation}
Consequently the standard lorentz decomposition into transversal and
longitudinal components reads
\begin{tcolorbox}[ams equation,myformula]
...
by two four-momenta and making use of the Ward-idendity \cref{eq:wardIdentity}
we can write
\begin{equation}
