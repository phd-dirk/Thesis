...
still maintained by former \textsc{aleph} group members under led by M. Davier,
...
ratio \(i\in\{\text{V,A,VpA}\}\). Thus we can connect the branching ratio of the
...
\begin{equation}
  \Rightarrow \rho(s) = \frac{s_\tau}{12 \pi^2 100 \mathcal{B}_e} \frac{\sfm2}{\omega_\tau}.
\end{equation}
...
extended \(\chi^2\) \cite{Boito2014}
\begin{tcolorbox}[ams equation,myformula]
  Q^2 = \sum_{\omega} \sum_{s_0^i,s_0^j}
  \left(I_{\omega}^{exp}(s_0^i) - I_{\omega}^{th}(s_0^i,\vec\alpha)\right)
  \widetilde{C}_{ij,\omega}^{-1}
...
error propagation \cite{Boito2011a,Boito2011}
\begin{equation}
