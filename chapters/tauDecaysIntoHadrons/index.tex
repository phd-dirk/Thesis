...
\define{ckm}{Cabibbo-Kobayashi-Maskawa} matrix element squared
...
\define{vsa}{vacuum saturation approximation}
...
\define{bs}{Borel summation}. The \textsc{bs} is a long known summation method
...
We have to distinguish between \define{uv}{ultraviolet} and
...
We apply the \define{ls}{method of least squares} to fit the parameters
