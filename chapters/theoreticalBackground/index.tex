...
\item \textbf{$\bm{\lambda}$ regularisation:} In $Lambda$ regularisation we
  ...
  Here $\Lambda$ has the dimension of mass. The cutoff regularisation breaks
...
Our method to measure the strong coupling are the \textsc{qcdsr}, which in our
case make use of the \textit{two-point function} for which we will devote the
following section
...
expectation value of two local fields. In the simplest case, for a scalar field
$\phi$, it is defined as
\begin{equation}
