...
\end{align}
The coefficients of the $\beta$-function and the mass anomalous dimension are currently known up to the 5\textsueprscript{th} order
...
\end{document}
% LocalWords:  qcdFeynmanDiagrams qcdFeynmanRules
